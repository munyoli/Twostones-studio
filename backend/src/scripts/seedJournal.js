...
const journalData = [
    ...
    },
    {
        ...
        q: "1. The Inhale of the Promise\nGod breathed His own name into your identity before your circumstances ever changed. If you looked at your current \"barren\" situation—that dream, that business, that promise—not as a dead end, but as a space already filled with God’s breath, how would your posture shift today? Can you trust the \"Inhale\" of His promise even before the \"Exhale\" of the result?\n\n2. The Integrity of the Wait\nSarah’s story shows that how we wait is very important. Does your speech currently align with a heart posture of waiting, or does your language reflect a \"panic season\"? Where has your speech drifted away from the promise God gave you?\n\n3. The Hagar Audit\nAnytime we put our hand in what God has already said He'll do, we face consequences. What \"Hagar\" (forced solution) are you currently holding onto because you don't trust the breath of God to move on its own? What would it look like to move from a posture of \"Helping\" to a posture of \"Hoping\"?\n\n4. The Final Trust\nDo you fully trust God to accomplish all His promises for you? The prophecies you’ve gotten—do you truly believe they’ll come to pass? All the big dreams God has given you, do you really trust they’ll come to fruition?",
        mirror: "The Conflict of the Shortcut\nWe see the temptation to \"help\" God when the waiting feels like a void. Hagar represents the moment we stop trusting God’s timing and start trusting our own hands. We often say we are in a \"waiting season,\" but our speech and our actions reveal a heart that is actually in a \"panic season.\"\n\nSarah’s conflict with Hagar is a mirror for us: anytime we put our hands on what God has already spoken, we create friction. We end up managing consequences instead of enjoying the promise.\n\nIntimate Reflection\nHow am I waiting today? Does my speech align with the \"breath\" God has placed in me, or am I trying to build a \"Hagar\" to solve a problem God has already covered?\n\nSarah reminds me that even when I laugh in disbelief, God is still moving. My doubt doesn't stop His breath. He is not just the God of the promise; He is the God of the redemption of my waiting.",
        encounter: "The Theology of the \"Hey\" (ה)\nBefore the miracle manifested in her body, it was woven into her name. God took Sarai and added the letter Hey (ה). In Hebrew, this letter is the \"Breath of God\"—the same Ruach breathed into the nostrils of the first man to bring life.\n\nI see now that the drought in her womb was answered by the atmosphere of her identity. Where God breathes, life is inevitable. Her barrenness was a physical fact, but her name was a spiritual promise. She wasn't just waiting for a child; she was carrying the essence of life in her very signature.",
        redemption: "Hoping Against Hope\nThere is a striking contrast between Abraham and Sarah. Romans 4:18 tells us Abraham \"hoped against hope,\" believing without a shadow of doubt. Yet, God does not disqualify Sarah for her laughter or her struggle.\n\nAbraham is the standard of faith that looks upward.\n\nSarah is the representation of how hard it is to wait while looking at a physical body that says \"no.\"\n\nGod redeemed her laughter. He didn't see her disbelief as an obstacle; He saw it as a human heart waiting to be surprised by His faithfulness. She is the \"Mother of Faith\" not because she was perfect, but because God was consistent."
    },
    {
